...
from arctic3d.modules.interface import parse_out_pdb, parse_out_uniprot, read_interface_residues
...
def test_parse_out_pdb():
    ...
    expected_pdb_sets = [set([]), set(["1abc"]), set(["4b2a","4b2c","4b1t"]), set(["4b2a","4b2c","4b1t"])]
    observed_pdb_sets = []
